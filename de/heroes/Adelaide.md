...
### 2 Spell: Eisstrahl
 **Description:** Fügt gegnerischen Einheiten in einem bestimmten Bereich <span style="color: #48b946">{($valueadd11+$valueadd12*($sklevel-1))}<span style="color: black"><($valueadd11+$valueadd12*($sklevel-1))*($a123+$a126+$a128+$a131)+$a101+(($valueadd11+$valueadd12*($sklevel-1))+($valueadd11+$valueadd12*($sklevel-1))*($a123+$a126+$a128+$a131)+$a101)*$talent2+$talent1> Wasserzauberschaden zu und verursacht zusätzlich <span style="color: #48b946">{($valueadd21+$valueadd22*($sklevel-1))}<span style="color: black"><($valueadd21+$valueadd22*($sklevel-1))*($a123+$a126+$a128+$a131)+$a101> Wasserzauberschaden bei <span style="color: #e07c44">verlangsamten Zielen.<span style="color: black">

### 3 Spell: Eismauer
 **Description:** Beschwört 1 Eismauer, die gegnerische Einheiten in der Nähe {($olast11+$olast12*($sklevel-1))/1000} Sek. lang <span style="color: #e07c44">einfriert.<span style="color: black">

### 4 Spell: Frostring
 **Description:** Fügt gegnerischen Einheiten in einem äußerst großen Bereich <span style="color: #48b946">{($valueadd11+$valueadd12*($sklevel-1))}<span style="color: black"><($valueadd11+$valueadd12*($sklevel-1))*($a123+$a126+$a128+$a131)+$a101+(($valueadd11+$valueadd12*($sklevel-1))+($valueadd11+$valueadd12*($sklevel-1))*($a123+$a126+$a128+$a131)+$a101)*$talent2+$talent1> Wasserzauberschaden zu und lässt <span style="color: #e07c44">verlangsamte<span style="color: black"> Ziele 5 Sek. lang <span style="color: #e07c44">erstarren.<span style="color: black">
 ...
 **Description:** Ich bin aus meinem Eisparadies zurückgekehrt, doch in der Welt sind Jahrzehnte vergangen.
 ...
 **Description:** Eine Heldin unter Helden und Champion der Arena! 
 ...
 **Description:** Niemand hat je den Winter von Vori überlebt.
 ...
 **Description:** Nach einem langen Jahr öffnen und verschließen wir unsere Herzen nur zu dieser Zeit.

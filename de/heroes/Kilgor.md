 ...
 **Description:** Erhöht die Zähigkeit aller verbündeten Einheiten um 50 und ihren krit. Schaden um 10 %. Verbündete Burg-Einheiten stellen alle 3 Sek. <span style="color: #48b946;font-size:20px">{($valueadd11+$valueadd12*($sklevel-1))}</span> LP wieder her. Dauer: <span style="color: #48b946;font-size:20px">{($bufflast11+$bufflast12*($sklevel-1))/1000} Sek.</span>

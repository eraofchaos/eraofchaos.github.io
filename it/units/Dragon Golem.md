...
## General information
 **Description:** L'apice della tecnologia degli Gnomi. Ogni singola parte di questa fusione tra macchina e magia trabocca di un potere inesauribile.
 ...
 **Info1:** Protezione ad area all'inizio della battaglia, che riduce i danni subiti. L'unità di difesa definitiva per le retrovie. Controllo a distanza, intimidisce tutte le unità in campo.

 **Info2:** Protezione ad area all'inizio della battaglia, che riduce i danni subiti. L'unità di difesa definitiva per le retrovie. Controllo a distanza, intimidisce tutte le unità in campo.

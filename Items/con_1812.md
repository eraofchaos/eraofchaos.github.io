 ...
 **Required Level to open:** 1
 ...
 1 You would get **ALL** items  from:
  ...
  |:---|:-------|:------------|:-----------:|
  | 1 | 1 | [Premium Artifact Component Pack](/Items/con_1507/) | Use it to select 1 of the following: Spellbinder`s Hat Component Chest *1, Hawkeye Component Chest *1 and Titan Component Chest *1 | 
  ...
  | 3 | 100 | [Heaven-Cast Stone](/Items/art_188/) | A crystal stone left over from the age of miracles. Essential material for Artifact upgrades. | 

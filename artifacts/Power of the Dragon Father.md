...
## Artifact components
  ...
  | 3 | **Red Dragon Flame Tongue** | A sword forged from flame dragon crystals. One of the components of Power of the Dragon Father. | Unit Attack: 6 + (LEVEL*2.4) %, Unit Health: 3 + (LEVEL*1.2) %, Hero Attack: 10 + (LEVEL*4) | 

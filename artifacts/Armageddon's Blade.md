...
## Artifact components
  ...
  | 3 | **Staff of Wisdom** | A relic that guards the Ice Shield. One of the components of Armageddon's Blade. | Unit Attack: 4 + (LEVEL*1.6) %, Hero Attack: 6 + (LEVEL*2.4), Hero Intelligence: 16 + (LEVEL*6.4) | 

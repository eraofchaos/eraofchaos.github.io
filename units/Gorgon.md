 ...
 **Description:** <span style="color: #645252;font-size:20px">Increases Gorgon's DEF by </span><span style="color: black"><span style="color: #48b946;font-size:20px"><span id="str1"></span>%</span><span style="color: black"><span style="color: #645252;font-size:20px"> and unit damage reduction by </span><span style="color: black"><span style="color: #48b946;font-size:20px"><span id="str2"></span>%</span><span style="color: black"><span style="color: #645252;font-size:20px">. If damage received by Gorgon from a single attack exceeds 15% of its max HP, it becomes immune to the damage beyond 15%.</span><span style="color: black">

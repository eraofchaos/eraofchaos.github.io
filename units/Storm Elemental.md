 ...
 **Description:** <span style="color: #645252">When battle starts, Storm Elemental units apply <span style="color: black"><span style="color: #48b946">\"Static\"<span style="color: black"><span style="color: #645252"> to all enemy units in its path for <span style="color: black"><span style="color: #48b946">{(($level+$ulevel)*1+11)}<span style="color: black"><span style="color: #645252">s.<span style="color: black">

### 2 Skill: Lightning Bounce
 **Description:** <span style="color: #645252">The Storm Elemental's normal attack has a <span style="color: black"><span style="color: #48b946">{($level+$ulevel)*1+5}%<span style="color: black"><span style="color: #645252"> chance of casting lightning at the target, causing 300% damage.<span style="color: black">

### 3 Skill: Elemental Force
 **Description:** <span style="color: #645252">When Storm Elemental is on the battlefield, it increases air magic resistance for all friendly units by <span style="color: black"><span style="color: #48b946">{($level+$ulevel)*1.8+5.7}%<span style="color: black"><span style="color: #645252"> and reduces air magic resistance for all enemy units by <span style="color: black"><span style="color: #48b946">{($level+$ulevel)*1.2+3.8}%<span style="color: black"><span style="color: #645252">. When Storm Elemental is on the battlefield, increases friendly hero's initial Mana by <span style="color: black"><span style="color: #48b946">{($level+$ulevel)*0.7+9.3}<span style="color: black"><span style="color: #645252">.<span style="color: black">

### 4 Skill: Static Pierce
 **Description:** <span style="color: #645252">Storm Elemental's unit's damage increased by <span style="color: black"><span style="color: #48b946">{($level+$ulevel)*1+9}%<span style="color: black"><span style="color: #645252">. The effect doubles if the target is suffering from <span style="color: black"><span style="color: #48b946">\"Static\"<span style="color: black"><span style="color: #645252">.<span style="color: black">

 ...
 **Info1:** Provoque Saignement en attaquant. Inflige des dégâts importants. Plus sa santé est basse, plus son attaque est puissante.

 **Info2:** Provoque Saignement en attaquant. Inflige des dégâts importants. Plus sa santé est basse, plus son attaque est puissante.

## Skills
### 1 Skill: Exécution experte
...
### 2 Skill: Couper
 **Description:** <span style="color: #645252;font-size:20px">L'attaque supplémentaire de l'Orque est augmentée de </span><span style="color: black"><span style="color: #48b946;font-size:20px">{($level+$ulevel)*60+240}</span><span style="color: black"><span style="color: #645252;font-size:20px"> et les dégâts de l'unité augmentent de </span><span style="color: black"><span style="color: #48b946;font-size:20px">{($level+$ulevel)*0.5+2.5} %</span><span style="color: black"><span style="color: #645252;font-size:20px">. Son attaque normale inflige </span><span style="color: black"><span style="color: #48b946;font-size:20px"><Saignement></span><span style="color: black"><span style="color: #645252;font-size:20px"> sur la cible pendant 6 secondes.</span><span style="color: black">

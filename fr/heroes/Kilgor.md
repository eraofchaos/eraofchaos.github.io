 ...
 **Description:** Augmente la Ténacité des unités alliées de 50 et leurs dégâts critiques de 10 %. Les alliés du Bastion régénèrent <span style="color: #48b946;font-size:20px">{($valueadd11+$valueadd12*($sklevel-1))}</span> PV toutes les 3s pendant <span style="color: #48b946;font-size:20px">{($bufflast11+$bufflast12*($sklevel-1))/1000}</span>s.

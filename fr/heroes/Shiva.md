 ...
 **Description:** Invoque 9 Élémentaires d'air de niveau <span style="color: #48b946">{$sklevel}<span style="color: black"> dans la zone cible. Ces unités persistent 20s et frappent à distance avec une ATQ de <span style="color: #48b946">{220+60*($sklevel-1)}<span style="color: black"><(220+60*($sklevel-1))*$talent14+$talent13> et <span style="color: #48b946">{3900+1694*($sklevel-1)}<span style="color: black"><(3900+1694*($sklevel-1))*$talent14+$talent13> PV.

### 4 Spell: Orage
 **Description:** Invoque une tempête dans la zone cible, infligeant <span style="color: #48b946">{($valueadd11+$valueadd12*($sklevel-1))*$sumnum}<span style="color: black"><(($valueadd11+$valueadd12*($sklevel-1))*$sumnum)*($a124+$a126+$a129+$a131)+$a101+(($valueadd11+$valueadd12*($sklevel-1))*$sumnum+(($valueadd11+$valueadd12*($sklevel-1))*$sumnum)*($a124+$a126+$a129+$a131)+$a101)*$talent2+$talent1> points de dégâts d'air à toutes les unités à portée toutes les 0,5s et réduisant leur vitesse d'ATQ de 15 %, pendant {$olast11/1000}s.
 ...
 **Description:** La tempête fait office d'ailes qui me permettent de voler et le ciel est mon terrain de chasse ! 

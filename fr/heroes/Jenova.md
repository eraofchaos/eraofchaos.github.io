...
### 4 Spell: Cœur pur
 **Description:** Invoque 4 Rois Licorne de niveau <span style="color: #48b946;font-size:20px">{$sklevel}</span> dans la zone cible. Ils persistent 20s avec une ATQ de <span style="color: #48b946;font-size:20px">{1200+320*($sklevel-1)}</span> et <span style="color: #48b946;font-size:20px">{5000+2200*($sklevel-1)}</span> PV.

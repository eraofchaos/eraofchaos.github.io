...
### 4 Spell: Bourbier
 **Description:** Invoque un Bourbier à un emplacement précis, qui restaure chaque seconde <span style="color: #e07c44;font-size:20px">3 %</span> des PV max des alliés de la Forteresse dans une large zone et augmente leur vitesse d'ATQ de <span style="color: #e07c44;font-size:20px">10 %</span> ; réduit la vitesse d'ATQ de <span style="color: #e07c44;font-size:20px">30 %</span> et la vitesse de déplacement de <span style="color: #e07c44;font-size:20px">60</span> pour toutes les unités ennemies au sol, pendant {($olast11+$olast12*($sklevel-1))/1000} secondes.

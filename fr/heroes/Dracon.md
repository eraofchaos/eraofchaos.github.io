...
### 4 Spell: Clone
 **Description:** Copie une de vos unités. Ce clone persiste 30s, possède <span style="color: #48b946">{($dupliatk11+$dupliatk12*($sklevel-1))} %<span style="color: black"> de l'ATQ de l'unité originale et subit des dégâts majorés de {($duplidmg11+$duplidmg12*($sklevel-1))} %.
 ...
 **Description:** Le savoir est magique et il est souvent synonyme de pouvoir !

...
### 4 Spell: Vent royal
 **Description:** Octroie <span style="color: #e07c44;font-size:20px">Exaltation</span> à toutes les unités alliées, augmentant leur ATQ de 50<50*($a122+$a126+$a132+$a136)> % pendant {($bufflast11+$bufflast12*($sklevel-1))/1000}s.

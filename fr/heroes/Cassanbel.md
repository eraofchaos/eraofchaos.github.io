 ...
 **Description:** Restaure <span style="color: #48b946;font-size:20px">{($valueadd11+$valueadd12*($sklevel-1))}</span><($valueadd11+$valueadd12*($sklevel-1))> PV pour les unités alliées à portée.
 ...
 **Description:** Lance un Raz-de-marée qui fracasse toutes les unités ennemies, infligeant <span style="color: #48b946;font-size:20px">{($valueadd11+$valueadd12*($sklevel-1))}</span><($valueadd11+$valueadd12*($sklevel-1))*($a123+$a126+$a128+$a131)+$a101+(($valueadd11+$valueadd12*($sklevel-1))+($valueadd11+$valueadd12*($sklevel-1))*($a123+$a126+$a128+$a131)+$a101)*$talent2+$talent3> points de dégâts d'eau et l'effet <span style="color: #e07c44;font-size:20px">Découragement</span> pour 10s. A également 20 % de chances de les <span style="color: #e07c44;font-size:20px">geler</span> pour 2s.

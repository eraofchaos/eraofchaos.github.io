...
## Rank Up
  ...
  |:-------------|:---------------:|:---------------:|
  | **- | **100x** [Arcane Chant Token](/Items/con_122/) | <Scalding Spark> Gog deals damage equal to 400% of own ATK to the target unit every 15s and inflicts them with Bleed for 7s. If the target unit is already Bleeding, DEF is reduced by 15% for 7s. |

---
title: "Exclusive - Miracle (Regnan Archer)"
 ...
 **Exclusive for Unit:** [Regnan Archer](/units/Regnan Archer/) 
...
## Rank Up
  ...
  | **4x** <i class="fas fa-star"/> | ? | Each time Regnan Archer triggers <Mythical Arrow>, increases ATK and Attack Speed of all friendly Cove units by 20% each for 6s. |
  | **5x** <i class="fas fa-star"/> | ? | Increases Regnan Archer's Life Drain by 30%. |
  | **6x** <i class="fas fa-star"/> | ? | <Safe Harbor> When Regnan Archer takes damage exceeding 20% of own Max HP in a single attack, they gain invincibility for 2s. |

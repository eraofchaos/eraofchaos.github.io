...
## Extra bonus
  ...
  | **20** | <Enhanced Castle> Increases Attack Speed by an additional 5%. | - |
  | **30** | Increases friendly hero's ATK by 40 (all heroes). | **+1500** |
  | **40** | <Enhanced Castle> Increases Unit DMG Reduction of Defensive units by an additional 10%. Effect doubles for Crusaders. | - |

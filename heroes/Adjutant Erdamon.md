...
## Extra bonus
  ...
  | **20** | <Enhanced Conflux> Increases Unit DMG Reduction by an additional 5%. | - |
  | **30** | Increases friendly hero's Intelligence by 40 (all heroes). | **+1500** |
  | **40** | <Enhanced Conflux> Increases base DEF by an additional 50. Increases base DEF of Stone Elemental by an additional 100. | - |

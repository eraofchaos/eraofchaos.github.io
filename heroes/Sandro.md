 ...
 **Description 4:** Deals earth damage to enemy units and has a 50% chance of causing<span style="color: #f0f000;font-size:18px">\"stun\"</span><span style="color: black">.
 ...
 **Description 2:** Next level, damage and healing increases by <span style="color: #1ca216;font-size:18px">{$valueadd12}</span><span style="color: black">, and the duration of Low Morale increases by <span style="color: #1ca216;font-size:18px">{$bufflast12/1000}s</span><span style="color: black">

 **Description 3:** Enemy deals damage

 **Description 4:** Deals earth damage to non-Necropolis enemy units and reduces their ATK speed. Recovers HP for friendly Necropolis units

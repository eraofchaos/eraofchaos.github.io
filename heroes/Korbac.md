 ...
 **Description:** Builds a Nest of Serpent Flies in target area, and summons 1 Lv.<span style="color: #48b946;font-size:20px">{$sklevel}</span> Serpent unit, which has an ATK of <span style="color: #48b946;font-size:20px">{250+68*($sklevel-1)}</span> and an HP of <span style="color: #48b946;font-size:20px">{2800+1216*($sklevel-1)}</span>. Lasts for 20s.

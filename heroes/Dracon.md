...
### 4 Spell: Clone
 **Description:** Copy 1 of friendly units to fight in the battlefield. It has [color=48b946,fontsize=20]{($dupliatk11+$dupliatk12*($sklevel-1))}%[-] of the original unit's ATK and takes {($duplidmg11+$duplidmg12*($sklevel-1))}% more damage. Lasts for 30s.

...
## Extra bonus
  ...
  | **20** | <Enhanced Air Magic> Decreases Air Magic Resistance of enemy units by an additional 15%. | - |
  | **30** | Increases friendly hero's Knowledge by 40 (all heroes). | **+1500** |
  | **40** | <Enhanced Air Magic> When casting air magic, friendly heroes deal damage equal to 3% of max HP to all enemy units in a wide range. | - |

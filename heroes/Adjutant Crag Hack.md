...
## Extra bonus
  ...
  | **20** | <To the Death> Increases Penetration by an additional 50 points. | - |
  | **30** | Increases friendly hero's DEF by 40 (all heroes). | **+1500** |
  | **40** | <To the Death> Increases Unit DMG of Melee units by 10% when fighting against bleeding enemies. | - |

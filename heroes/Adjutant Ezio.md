...
## Extra bonus
  ...
  | **20** | When a friendly hero casts a support spell, the assassin will cast Eagle Vision, which lasts for 3s. CD is 10s. | - |
  | **30** | Increases friendly hero's ATK by 60 (all heroes). | **+1500** |
  | **40** | <Nothing is True>'s Critical DMG buff is effective on all factions. | - |

...
## Extra bonus
  ...
  | **20** | <Frightful Aura> Increases Unit DMG by an additional 5%. | - |
  | **30** | Increases friendly hero's DEF by 60 (all heroes). | **+1500** |
  | **40** | <Frightful Aura> Increases Unit DMG Reduction of Melee units by an additional 10%. Effect doubles for Black Knight. | - |

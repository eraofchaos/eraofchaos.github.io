...
## Extra bonus
  ...
  | **20** | <Enhanced Water Magic> Decreases Water Magic Resistance of enemy units by an additional 15%. | - |
  | **30** | Increases friendly hero's Knowledge by 40 (all heroes). | **+1500** |
  | **40** | <Enhanced Water Magic> Friendly units deal 30% more damage to frozen enemies. | - |

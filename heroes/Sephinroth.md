 ...
 **Description:** Deals <span style="color: #48b946">{($valueadd11+$valueadd12*($sklevel-1))}</span><($valueadd11+$valueadd12*($sklevel-1))*($a125+$a126+$a130+$a131)+$a101> earth spell damage to hostile non-<span style="color: #e07c44">petrified</span> units within a very large range, and <span style="color: #e07c44">petrifies</span> them for <span style="color: #48b946">{($bufflast11+$bufflast12*($sklevel-1))/1000}</span>s. Deals double damage to <span style="color: #e07c44">petrified</span> hostile units.

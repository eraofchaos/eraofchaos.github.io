...
## Extra bonus
  ...
  | **20** | <Precision Strike> Increases Critical Hit by an additional 100 points. | - |
  | **30** | Increases friendly hero's Knowledge by 40 (all heroes). | **+1500** |
  | **40** | <Precision Strike> Increases the attack range of Wood Elves and Marksmen by an additional 50. | - |

...
### 2 Spell: Curse
 **Description:** Decreases units' ATK of targeted enemy within a large range by <span style="color: #48b946;font-size:20px">{-($buffaddattr12+$buffaddattr13*($sklevel-1))}</span><-($buffaddattr12+$buffaddattr13*($sklevel-1))*($a122+$a126+$a132+$a136)><span style="color: #48b946;font-size:20px">%</span> for <span style="color: #48b946;font-size:20px">{($bufflast11+$bufflast12*($sklevel-1))/1000}</span><($bufflast11+$bufflast12*($sklevel-1))/1000*$talent4+$talent3>s.
...
### 4 Spell: Dragon Roar
 **Description:** Inflict <span style="color: #e07c44;font-size:20px">Bleed</span> on all enemy units, dealing damage equal to <span style="color: #48b946;font-size:20px">{($ovaluepro21+$ovaluepro22*($sklevel-1))}%</span> of their Max HP every 2s, lasting for 16s, and <span style="color: #e07c44;font-size:20px">stun</span> them for 6s. Some units may become immune to the <span style="color: #e07c44;font-size:20px">bleed</span> damage, and the <span style="color: #e07c44;font-size:20px">bleeding</span> units have reduced healing received.

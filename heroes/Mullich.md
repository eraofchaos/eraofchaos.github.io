...
### 3 Spell: Fast Attack
 **Description:** Increases ATK speed by [color=48b946,fontsize=20]{($buffaddattr12+$buffaddattr13*($sklevel-1))}[-]<($buffaddattr12+$buffaddattr13*($sklevel-1))*($a124+$a126+$a134+$a136)>[color=48b946,fontsize=20]%[-] and movement speed by {$buffaddattr22+$buffaddattr23*($sklevel-1)}<($buffaddattr22+$buffaddattr23*($sklevel-1))*($a124+$a126+$a134+$a136)> for friendly units in a large range for {($bufflast11+$bufflast12*($sklevel-1))/1000}<($bufflast11+$bufflast12*($sklevel-1))/1000*$talent4+$talent3>s.

### 4 Spell: Time Stop
 **Description:** Summons a large range of Time Field, immobilizing enemy units in range for [color=48b946,fontsize=20]{($olast11+$olast12*($sklevel-1))/1000}[-]s.

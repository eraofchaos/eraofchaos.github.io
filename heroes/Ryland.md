 ...
 **Description:** Summons 9 Treants of Lv.[color=48b946,fontsize=20]{$sklevel}[-] in the target area with an ATK of [color=48b946,fontsize=20]{220+60*($sklevel-1)}[-]<(220+60*($sklevel-1))*$talent14+$talent13> and HP of [color=48b946,fontsize=20]{3200+1391*($sklevel-1)}[-]<(3200+1391*($sklevel-1))*$talent14+$talent13>, lasting throughout the entire battle.

### 4 Spell: Prayer
 **Description:** Restore [color=48b946,fontsize=20]{($ovalueadd11+$ovalueadd12*($sklevel-1))*($olast11/$ointerval)}[-]<($ovalueadd11+$ovalueadd12*($sklevel-1))*($olast11/$ointerval)*($a123+$a126+0.4*$a128+0.4*$a131+$a133+$a136)> HP for friendly units within a large range. The HP restored for targets with a [color=e07c44,fontsize=20]shield[-] doubles.

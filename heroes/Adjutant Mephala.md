...
## Extra bonus
  ...
  | **20** | <Defensive Formation> Increases Unit DMG Reduction by an additional 5%. | - |
  | **30** | Increases friendly hero's ATK by 40 (all heroes). | **+1500** |
  | **40** | <Defensive Formation> Increases the effectiveness of Shields received by friendly units by 10%. | - |

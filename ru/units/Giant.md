 ...
 **Base ATK:** 792.0
  ...
  | Фиолетовый +3 | 3722.4 | 37.6 | 46262.1 |
 ...
 **Описание:** <span style="color: #645252;font-size:20px">Чем ближе гигант к цели, тем выше у него АТК. Он получает </span><span style="color: black"><span style="color: #48b946;font-size:20px">+{($level+$ulevel)*2+8}%</span><span style="color: black"><span style="color: #645252;font-size:20px"> к АТК за каждые 100 ед. расстояния до цели. Когда активируется «Магическое пробуждение», с гиганта снимаются все ослабления, за исключением эффектов ауры.</span><span style="color: black">

...
---
## General information
 **Description:** Никто не знает, где орки прячут свои метательные топоры, но кажется, что запасы их бесконечны.
 ...
 **Info1:** При атаке вызывает кровотечение. Наносит высокий урон. Чем ниже здоровье, тем выше показатель атаки.

 **Info2:** При атаке вызывает кровотечение. Наносит высокий урон. Чем ниже здоровье, тем выше показатель атаки.

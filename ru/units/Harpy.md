 ...
 **Info1:** Высокий УВС. Подавляет наземные отряды и создает возможности для атаки союзных отрядов.

 **Info2:** Высокий УВС. Подавляет наземные отряды и создает возможности для атаки союзных отрядов.

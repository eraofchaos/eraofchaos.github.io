...
toc: true
---
 **Description:** Aunque perdió a su «padre» por culpa de los humanos, sigue ayudando a quienes viven en el mar.
## Details
 ...
 **Description:** Restaura <span style="color: #48b946;font-size:20px">{($valueadd11+$valueadd12*($sklevel-1))}</span><span style="color: black"><($valueadd11+$valueadd12*($sklevel-1))> PV a las unidades amistosas a cierta distancia.
 ...
 **Description:** <span style="color: #ffffff;font-size:20px">¡Protegeré a los débiles Inframares y acabaré con los piratas acosadores!</span>

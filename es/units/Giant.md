 ...
 **Descripción:** <span style="color: #645252;font-size:20px">Cuanto más lejos esté el Gigante de su objetivo, mayor es su ataque. Aumenta un </span><span style="color: black"><span style="color: #48b946;font-size:20px">{($level+$ulevel)*2+8}%</span><span style="color: black"><span style="color: #645252;font-size:20px"> el ataque por cada 100 de alcance. Cuando se activa &lt;Despertar mágico&gt;, se disipan las penalizaciones de los Gigantes (salvo los efectos de auras)</span><span style="color: black">

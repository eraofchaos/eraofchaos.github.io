 ...
 **Info:** Reduce la precisión de tus enemigos y tiene un alto valor de esquiva.
 ...
 **Descripción:** <span style="color: #645252;font-size:20px">Aumenta la esquiva del Unicornio un </span><span style="color: black"><span style="color: #48b946;font-size:20px">{($level+$ulevel)*20+80}</span><span style="color: black"><span style="color: #645252;font-size:20px">. Otorga al Unicornio 40 de esquiva adicional por cada unidad arquera aliada en el campo de batalla.</span><span style="color: black">
